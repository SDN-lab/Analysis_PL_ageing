function [fval,fit] = mod_ms_RWPL_SO_LR_comb(behavData,q, doprior,dofit,varargin)
...
qt = norm2par('ms_RWPL_SO_LR_comb',q); % transform parameters from gaussian space to model space
...
if dofit ==1
   ...
   fit         = struct;
   fit.xnames  = {'beta'; 'alpha_self'; 'alpha_other';};
